...
contract MintBasicNft is Script {
    ...
    function run() external {
        ...
        mintNftOfContract(mostRecentlyDeployedBasicNft);
    }

    function mintNftOfContract(address basicNftAddress) public {
        vm.startBroadcast();
...
contract MintMoodNft is Script {
    ...
    function mintNftOfContract(address moodNftAddress) public {
        vm.startBroadcast();
